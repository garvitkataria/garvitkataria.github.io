...
module.exports = "\n\n.container {\n  padding-top: 50px;\n  padding-bottom: 10px;\n  color: #405065;\n}\n\n.search-hero {\n  max-width: 400px;\n  padding-bottom: 50px;\n  margin:auto;\n}\n\n.form-control {\n  box-shadow: 0 10px 40px 0 #B0C1D9;\n  width: 400px;\n}\n\n.form-control::-webkit-input-placeholder  {\n  font-family: FontAwesome;\n}\n\n.form-control::-moz-placeholder  {\n  font-family: FontAwesome;\n}\n\n.form-control::-ms-input-placeholder  {\n  font-family: FontAwesome;\n}\n\n.form-control::placeholder  {\n  font-family: FontAwesome;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _service_bank_details_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service/bank-details.service */ "./src/app/service/bank-details.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataService) {
        ...
        this.title = 'Banks Search Application';
        this.location = "BANGALORE";
        this.banks_length = 0;
        this.loader_flag = 0;
        this.banks = [];
        this.favourite_banks = [];
        this.show_banks = [];
        this.page_size = 50;
        this.table_flag = 0;
        ...
        if (localStorage.getItem(this.location)) {
            ...
            this.dataService.getBank(this.location).subscribe(function (res) {
                console.log(res);
                _this.banks = res.json();
                console.log(_this.banks[0]);
                _this.banks_length = _this.banks.length;
                _this.loader_flag = 1;
                localStorage.setItem(_this.location, JSON.stringify(_this.banks));
                _this.show_banks = _this.banks;
            });
        }
    }
    AppComponent.prototype.changeLocation = function () {
        var _this = this;
        this.loader_flag = 0;
    ...
    AppComponent.prototype.addFavouriteBank = function (bank) {
        console.log(bank);
        var check = 1;
    ...
    AppComponent.prototype.changePageSize = function (size) {
        this.page_size = size;
    };
    AppComponent.prototype.changeTable = function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_bank_details_service__WEBPACK_IMPORTED_MODULE_1__["BankDetailsService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _service_bank_details_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./service/bank-details.service */ "./src/app/service/bank-details.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_service_bank_details_service__WEBPACK_IMPORTED_MODULE_6__["BankDetailsService"]],
        })
    ], AppModule);
    return AppModule;
}());
...
/***/ "./src/app/service/bank-details.service.ts":
/*!*************************************************!*\
  !*** ./src/app/service/bank-details.service.ts ***!
  \*************************************************/
...
var BankDetailsService = /** @class */ (function () {
    ...
    BankDetailsService.prototype.getBank = function (location) {
        ...
        return this.http.get(this.server + location);
    };
...
module.exports = __webpack_require__(/*! /Users/garvitkataria/Downloads/angular-search-filter/src/main.ts */"./src/main.ts");
